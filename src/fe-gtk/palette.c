...
GdkColor colors[] = {
	...
	{0, 0xBBBB, 0x0000, 0x0000}, /* 04 red */
	{0, 0xFFFF, 0x5555, 0x5555}, /* 05 bright red */
	{0, 0xBBBB, 0x0000, 0xBBBB}, /* 06 purple */
	{0, 0x8080, 0x5555, 0x0000}, /* 07 orange */
	{0, 0xFFFF, 0xFFFF, 0x5555}, /* 08 bright yellow */
	{0, 0x5555, 0xFFFF, 0x5555}, /* 09 green */
	{0, 0x0000, 0xBBBB, 0xBBBB}, /* 10 cyan */
	{0, 0x5555, 0xFFFF, 0xFFFF}, /* 11 bright cyan */
	{0, 0x5555, 0x5555, 0xFFFF}, /* 12 bright blue */
	{0, 0xb0b0, 0x3737, 0xb0b0}, /* 13 bright purple */

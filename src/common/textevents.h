...
N_("%C27*%O$t$1 added to notify list.")},

{"Ban List", pevt_banlist_help, 4, 
N_("%C27*%O$t$1 Banlist:%C19 $4%C20 $2%C21 $3")},

{"Banned", pevt_generic_channel_help, 1, 
N_("%C27*%O$tCannot join%C26 %B$1 %O(You are banned).")},

{"Beep", pevt_generic_none_help, 128, 
""},

{"Change Nick", pevt_changenick_help, 2, 
N_("%C27*%O$t$1 is now known as $2")},
...
N_("%C27*%O$tChannel $1 created on $2")},
...
N_("%C27*%O$t%C27Channel $1 modes: $2")},
...
N_("%C27*%O$t%C27Connected. Now logging in...")},

{"Connecting", pevt_connect_help, 3, 
N_("%C27*%O$t%C27Connecting to $1 ($2) port $3%O...")},

{"Connection Failed", pevt_connfail_help, 1, 
N_("%C21*%O$t%C21Connection failed. Error: $1")},

{"CTCP Generic", pevt_ctcpgen_help, 2, 
N_("%C27*%O$tReceived a CTCP $1 from $2")},

{"CTCP Generic to Channel", pevt_ctcpgenc_help, 3, 
N_("%C27*%O$tReceived a CTCP $1 from $2 (to $3)")},

{"CTCP Send", pevt_ctcpsend_help, 2, 
N_("%C19>%O$1%C19<%O$tCTCP $2")},

{"CTCP Sound", pevt_ctcpsnd_help, 2, 
N_("%C27*%O$tReceived a CTCP Sound $1 from $2")},

{"CTCP Sound to Channel", pevt_ctcpsnd_help, 3, 
N_("%C27*%O$tReceived a CTCP Sound $1 from $2 (to $3)")},

{"DCC CHAT Abort", pevt_dccchatabort_help, 1, 
N_("%C27*%O$tDCC CHAT to %C26$1%O aborted.")},

{"DCC CHAT Connect", pevt_dccchatcon_help, 2, 
N_("%C27*%O$tDCC CHAT connection established to %C26$1 %C30[%O$2%C30]")},

{"DCC CHAT Failed", pevt_dccchaterr_help, 4, 
N_("%C27*%O$tDCC CHAT to %C26$1%O lost ($4).")},

{"DCC CHAT Offer", pevt_generic_nick_help, 1, 
N_("%C27*%O$tReceived a DCC CHAT offer from $1")},

{"DCC CHAT Offering", pevt_generic_nick_help, 1, 
N_("%C27*%O$tOffering DCC CHAT to $1")},

{"DCC CHAT Reoffer", pevt_generic_nick_help, 1, 
N_("%C27*%O$tAlready offering CHAT to $1")},

{"DCC Conection Failed", pevt_dccconfail_help, 3, 
N_("%C27*%O$tDCC $1 connect attempt to%C26 $2%O failed (err=$3).")},

{"DCC Generic Offer", pevt_dccgenericoffer_help, 2, 
N_("%C27*%O$tReceived '$1%O' from $2")},

{"DCC Header", pevt_generic_none_help, 0, 
N_("%C24,18 Type  To/From    Status  Size    Pos     File         ")},

{"DCC Malformed", pevt_malformed_help, 2, 
N_("%C27*%O$tReceived a malformed DCC request from %C26$1%O.%010%C27*%O$tContents of packet: $2")},

{"DCC Offer", pevt_dccoffer_help, 3, 
N_("%C27*%O$tOffering%C26 $1%O to%C26 $2")},

{"DCC Offer Not Valid", pevt_generic_none_help, 0, 
N_("%C27*%O$tNo such DCC offer.")},

{"DCC RECV Abort", pevt_dccfileabort_help, 2, 
N_("%C27*%O$tDCC RECV%C26 $2%O to%C26 $1%O aborted.")},

{"DCC RECV Complete", pevt_dccrecvcomp_help, 4, 
N_("%C27*%O$tDCC RECV%C26 $1%O from%C26 $3%O complete %C30[%C26$4%O cps%C30]%O.")},

{"DCC RECV Connect", pevt_dcccon_help, 3, 
N_("%C27*%O$tDCC RECV connection established to%C26 $1 %C30[%O$2%C30]")},

{"DCC RECV Failed", pevt_dccrecverr_help, 4, 
N_("%C27*%O$tDCC RECV%C26 $1%O from%C26 $3%O failed ($4).")},

{"DCC RECV File Open Error", pevt_generic_file_help, 2, 
N_("%C27*%O$tDCC RECV: Cannot open $1 for writing ($2).")},

{"DCC Rename", pevt_dccrename_help, 2, 
N_("%C27*%O$tThe file%C26 $1%C already exists, saving it as%C26 $2%O instead.")},

{"DCC RESUME Request", pevt_dccresumeoffer_help, 3, 
N_("%C27*%O$t%C26$1 %Ohas requested to resume%C26 $2 %Cfrom%C26 $3%C.")},

{"DCC SEND Abort", pevt_dccfileabort_help, 2, 
N_("%C27*%O$tDCC SEND%C26 $2%O to%C26 $1%O aborted.")},

{"DCC SEND Complete", pevt_dccsendcomp_help, 3, 
N_("%C27*%O$tDCC SEND%C26 $1%O to%C26 $2%O complete %C30[%C26$3%O cps%C30]%O.")},

{"DCC SEND Connect", pevt_dcccon_help, 3, 
N_("%C27*%O$tDCC SEND connection established to%C26 $1 %C30[%O$2%C30]")},

{"DCC SEND Failed", pevt_dccsendfail_help, 3, 
N_("%C27*%O$tDCC SEND%C26 $1%O to%C26 $2%O failed. $3")},

{"DCC SEND Offer", pevt_dccsendoffer_help, 4, 
N_("%C27*%O$t%C26$1 %Ohas offered%C26 $2 %O(%C26$3 %Obytes)")},

{"DCC Stall", pevt_dccstall_help, 3, 
N_("%C27*%O$tDCC $1%C26 $2 %Oto%C26 $3 %Cstalled - aborting.")},

{"DCC Timeout", pevt_dccstall_help, 3, 
N_("%C27*%O$tDCC $1%C26 $2 %Oto%C26 $3 %Otimed out - aborting.")},

{"Delete Notify", pevt_generic_nick_help, 1, 
N_("%C27*%O$t$1 deleted from notify list.")},

{"Disconnected", pevt_discon_help, 1, 
N_("%C27*%O$tDisconnected ($1).")},

{"Found IP", pevt_foundip_help, 1, 
N_("%C27*%O$tFound your IP: [$1]")},
...
N_("%C27*%O$tCannot join%C26 %B$1 %O(Channel is invite only).")},

{"Invited", pevt_invited_help, 3, 
N_("%C27*%O$tYou have been invited to%C26 $1%O by%C26 $2%C (%C26$3%C)")},

{"Join", pevt_join_help, 3, 
N_("%C19*%O$t%C19%B$1 %B($3) has joined $2")},

{"Keyword", pevt_generic_channel_help, 1, 
N_("%C27*%O$tCannot join%C26 %B$1 %O(Requires keyword).")},

{"Kick", pevt_kick_help, 4, 
N_("%C21*%O$t%C21$2 was kicked from $3 by $1: $4")},

{"Killed", pevt_kill_help, 2, 
N_("%C27*%O$tYou have been killed by $1 ($2%O%C27)")},
...
N_("%C27*%O$t%C27MOTD Skipped.")},

{"Nick Clash", pevt_nickclash_help, 2, 
N_("%C27*%O$t$1 already in use. Retrying with $2...")},

{"Nick Failed", pevt_generic_none_help, 0, 
N_("%C27*%O$tNickname already in use. Use /NICK to try another.")},

{"No DCC", pevt_generic_none_help, 0, 
N_("%C27*%O$tNo such DCC.")},

{"No Running Process", pevt_generic_none_help, 0, 
N_("%C27*%O$tNo process is currently running")},
...
N_("%C27*%O$t$1 users in notify list.")},

{"Notify Offline", pevt_generic_nick_help, 3, 
N_("%C27*%O$tNotify: $1 is offline ($3).")},

{"Notify Online", pevt_generic_nick_help, 3, 
N_("%C27*%O$tNotify: $1 is online ($3).")},
...
N_("%C27*%O$tPing reply from $1: $2 second(s)")},

{"Ping Timeout", pevt_pingtimeout_help, 1, 
N_("%C27*%O$tNo ping reply for $1 seconds, disconnecting.")},
...
N_("%C27*%O$tA process is already running")},

...
N_("-%C10-%C11-%O$tReceived a CTCP Sound $1 from $2 (to $3)")},
...
N_("-%C10-%C11-%O$t%C28[%O$1%C28]%O $2")},
...
N_("-%C10-%C11-%O$t%C23Netsplit detected between servers $1 and $2.")},

{"Netsplit Victims", pevt_generic_none_help, 1, 
N_("-%C10-%C11-%O$t%C23Netsplit victims: $1")},
};

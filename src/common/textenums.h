...
enum
{
	...
	XP_TE_WHOIS_AWAY,		XP_TE_WHOIS_CHANNELS,
	XP_TE_WHOIS_OPER,		XP_TE_WHOIS_END,
	XP_TE_WHOIS_ID,		XP_TE_WHOIS_IDLE,
	XP_TE_WHOIS_IDLE_SIGNON,		XP_TE_WHOIS_NAME,
	XP_TE_WHOIS_REALHOST,		XP_TE_WHOIS_SERVER,
	XP_TE_WHOIS_SPECIAL,		XP_TE_UJOIN,
	XP_TE_UKICK,		XP_TE_UPART,
	XP_TE_UPARTREASON,		XP_TE_UACTION,
	XP_TE_UINVITE,		XP_TE_UCHANMSG,
	XP_TE_UCHANGENICK,		XP_TE_NS_START,
	XP_TE_SASL_AUTH,		XP_TE_PLUGIN_LOADED,
	XP_TE_PLUGIN_UNLOADED,		XP_TE_PLUGIN_ERROR,
	NUM_XP
};

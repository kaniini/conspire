...
/* VOID:POINTER,POINTER,UINT,UINT (marshallers.list:1) */
extern void g_cclosure_user_marshal_VOID__POINTER_POINTER_UINT_UINT (GClosure     *closure,
                                                                     GValue       *return_value,
...
void
g_cclosure_user_marshal_VOID__POINTER_POINTER_UINT_UINT (GClosure     *closure,
                                                         GValue       *return_value,
                                                         guint         n_param_values,
                                                         const GValue *param_values,
                                                         gpointer      invocation_hint,
...
/* VOID:POINTER,UINT,UINT (marshallers.list:2) */
extern void g_cclosure_user_marshal_VOID__POINTER_UINT_UINT (GClosure     *closure,
                                                             GValue       *return_value,
                                                             guint         n_param_values,
                                                             const GValue *param_values,
                                                             gpointer      invocation_hint,
